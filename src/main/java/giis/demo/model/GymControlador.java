...
public class GymControlador {
	...
	private static HashMap<String, Instalacion> instalaciones;
	...
	public static HashMap<String, Instalacion> getInstalaciones() {
	...
	public static void cerrarInstalacion(Instalacion i) {
		instalaciones.remove(i.getNombre(),i);
	}
	
	public static void abrirInstalacion(Instalacion i) {
		instalaciones.put(i.getNombre(), i);
	}
	...
	public static void cargarIns() {
		instalaciones = Db.cargarInstalacionesDisponibles();
	}
